...
class GenerateRequest(BaseModel):
    ...
    start: Literal["replay", "live"] = Field(
        ...
        description=(
            ...
            "money must never spend it** — the recorded Strait of Hormuz run's own "
            "receipt reads 29 model calls, about thirty-six minutes and $4.04, "
            "which is what the other reading of a silent request could cost. That "
